...
**Windows:** You can use Git Bash if you have Git installed on your machine, which will allow you to use the traditional commands in this guide. 

### !callout-info
# Unix vs. Windows
You'll find that many commands in Windows differ from the traditional Unix/Bash commands in this guide, so you'll need to use different commands on the Windows terminal. There's also the modern Power Shell and Power Shell ISE, the latter of which offers auto-complete and visual aids. Either of these CLI tools will work fine for Windows.
### !end-callout

Additional Windows Resources:
* [CLI Reference](https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/windows-commands)
* [SS64.com CMD Reference](https://ss64.com/nt/)
